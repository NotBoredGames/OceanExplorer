...
public class NEW_FieldOfViewScript : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        if (useTurretAim && aimScript == null)
        {
            Debug.Break();
        ...
        viewMeshFilter.gameObject.GetComponent<MeshRenderer>().sortingOrder = 99;
    ...
    void Update()
    {
        if (useTurretAim)
        {
            ...
            forward = aimScript.GetAimVector().normalized;
        }
        else
    ...
    void DrawFOV()
    {
        ...
        vertices[0] = Vector3.zero + gunPivot.localPosition;
